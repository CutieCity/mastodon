  ...
  render () {
    ...
    if (tag) {
      ...
      followButton = (
        ...
        */
        <button className={classNames('column-header__button', 'follow-hashtag', {  active: following })} onClick={this.handleFollow} disabled={!signedIn} title={intl.formatMessage(following ? messages.unfollowHashtag : messages.followHashtag)} aria-label={intl.formatMessage(following ? messages.unfollowHashtag : messages.followHashtag)}>
